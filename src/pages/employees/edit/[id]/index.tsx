      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="payroll" mb="4" isInvalid={!!formik.errors?.payroll}>
              <FormLabel>Payroll</FormLabel>
              <NumberInput
                name="payroll"
                value={formik.values?.payroll}
                onChange={(valueString, valueNumber) =>
                  formik.setFieldValue('payroll', Number.isNaN(valueNumber) ? 0 : valueNumber)
                }
              >
                <NumberInputField />
                <NumberInputStepper>
              ...
              {formik.errors.payroll && <FormErrorMessage>{formik.errors?.payroll}</FormErrorMessage>}
            </FormControl>
